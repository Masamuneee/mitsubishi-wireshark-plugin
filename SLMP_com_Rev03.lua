...
ExitCode = {
	...
	[0xC200] = "Password length error (must be 6-32 characters)."																	,
	[0xC810] = "Authentication error (password incorrect)."																			,
	[0xC815] = "Authentication failure - rate limiting triggered."																	,
	[0xC816] = "Authentication locked (rate limit reached)."																		,
